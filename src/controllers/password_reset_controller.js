  ...
  const params = {
    ...
    Message: { /* required */
      Body: { /* required */
        Html: {
          Charset: 'UTF-8',
          Data: 'We received a request to reset the password to access the Magnuson Center Campus Ventures web application with your email address\nClick here to change your password:\n'.concat(url).concat('\nIf you do not the use Magnuson Center Campus Ventures web application or did not request a password reset, please ignore this email or contact support if you have questions.\n\nThanks,\nThe MCCV Team'),
        },
      },
      Subject: {
        Charset: 'UTF-8',
